...
uses
  ...
  FMX.Layouts, FMX.Viewport3D, FMX.StdCtrls, FMX.Ani;
...
type
  TForm1 = class(TForm)
    ...
    procedure PanPlusClick(Sender: TObject);
    procedure ZoomInClick(Sender: TObject);
    procedure ZoomOutClick(Sender: TObject);
    procedure PanMinusClick(Sender: TObject);
  private
...
begin
  Camera1.AnimateFloat( 'Position.Z', Camera1.Position.Z + 2, 0.5 );
end;
...
procedure TForm1.PanPlusClick(Sender: TObject);
begin
  Camera1.AnimateFloat( 'Position.Y', Camera1.Position.Y + 2, 0.5 );
end;


procedure TForm1.PanMinusClick(Sender: TObject);
begin
  Camera1.AnimateFloat( 'Position.Y', Camera1.Position.Y - 2, 0.5 );
end;
